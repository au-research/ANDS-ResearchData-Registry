...
<div id="view_template" class="hide">
	...
	<div id="breadcrumb">
		...
		<div class="pull-right">
			<span class="label"><i class="icon-question-sign icon-white"></i> <a target="_blank" style="color:white;" href="https://documentation.ardc.edu.au/display/DOC/Data+Source+Account+Dashboard">Help</a></span>
		</div>
	</div>
...
<div id="settings_template" class="hide">
	...
	<div id="breadcrumb">
		...
		<div class="pull-right">
			<span class="label"><i class="icon-question-sign icon-white"></i> <a target="_blank" style="color:white;" href="https://documentation.ardc.edu.au/display/DOC/Account+Administration+Information">Help</a></span>
		</div>
	</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						<h4>Account Administration Information <sup><a href="https://documentation.ardc.edu.au/display/DOC/Account+Administration+Information" target="_blank" class="muted">?</a></sup></h4>
						...
						<dl class="dl-horizontal dl-wide">
							<dt>Reverse Links <sup><a href="https://documentation.ardc.edu.au/display/DOC/Account+Administration+Information" target="_blank" class="muted">?</a></sup></dt>
							<dd>
							...
							<dt>Create Primary Relationships <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></dt>
							<dd><p><span checkbox="ds.create_primary_relationships"></span></p></dd>
							<dt>Manually Publish <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></dt>
							<dd><p><span checkbox="ds.manual_publish"></span></p></dd>
							<dt>Quality Assessment Required <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></dt>
							<dd><p><span checkbox="ds.qa_flag"></span></p></dd>
							<span ng-show="ds.assessment_notify_email_addr">
								<dt>Assessment Notification Email <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></dt>
						...
						<h4>Harvester Settings <sup><a href="https://documentation.ardc.edu.au/display/DOC/Harvester+Settings" target="_blank" class="muted">?</a></sup></h4>
						<dl class="dl-horizontal dl-wide">
...
<div id="edit_template" class="hide">
	...
	<div id="breadcrumb">
		...
		<div class="pull-right">
			<span class="label"><i class="icon-question-sign icon-white"></i> <a target="_blank" style="color:white;" href="https://documentation.ardc.edu.au/display/DOC/Data+Source+Account+Settings">Help</a></span>
		</div>
	</div>
				...
				<div class="widget-content nopadding">
					<form class="form-horizontal">
						<div ng-show="tab=='admin'">
							<fieldset>
								<legend>Account Administration Information <sup><a href="https://documentation.ardc.edu.au/display/DOC/Data+Source+Account+Settings" target="_blank" class="muted">?</a></sup></legend>
								<div class="control-group">
									<label class="control-label">Key</label>
									<div class="controls">
						...
						<div ng-show="tab=='records'">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">Reverse Links <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></label>
									<div class="controls">
								...
								<div class="control-group">
									<label class="control-label">
										Primary Relationships <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup>
									</label>
									<div class="controls">
										...
										<div ng-show="ds.create_primary_relationships" class="well" style="margin-top:10px;">
											<i>Data Sources can have up to 2 Primary Records <sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup></i>
											<div class="clearfix"></div>
											<div class="pull-left">
												<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label">Manually Publish Records
										<sup><a href="https://documentation.ardc.edu.au/display/DOC/Records+Management+Settings" target="_blank" class="muted">?</a></sup>
									</label>
									<div class="controls">
						...
						<div ng-show="tab=='harvester' && ds.harvester_methods">
							<fieldset>
								<legend>Harvester Settings
									<sup><a href="https://documentation.ardc.edu.au/display/DOC/Harvester+Settings" target="_blank" class="muted">?</a></sup>
								</legend>
